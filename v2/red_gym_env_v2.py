...
class RedGymEnv(Env):
    ...
    def get_levels_reward(self): 
        ...
        if level_sum < 20:
            ...
            scaled = 20 + ((level_sum - 20) / 4)
        else:
            scaled = 25 + ((level_sum - 40) / 8)
    ...
    def get_game_state_reward(self, print_stats=True):
        ...
        state_scores = {
            ...
            "items": self.reward_scale * self.get_item_reward() * 0.1,
            "seen": self.reward_scale * self.get_pokedex_seen(),
            "captured": self.reward_scale * self.get_pokedex_caught() * 3,
            "menu_rewards": (self.start_menu_count + self.start_stats_count + self.start_pokemenu_count + self.start_itemmenu_count) * 0.01,
