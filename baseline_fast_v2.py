...
if __name__ == "__main__":
    ...
    env_config = {
                ...
                'gb_path': '../PokemonRed.gb', 'debug': False, 'reward_scale': 1, 'explore_weight': 0.015
            }
    ...
    file_name = "session_7edf7249/poke_47185920_steps" # "session_8d5a9983/poke_32768000_steps" # <- a cerulean checkpoint
    ...
    if exists(file_name + ".zip"):
        ...
        model = PPO("MultiInputPolicy", env, verbose=1, n_steps=train_steps_batch, batch_size=512, n_epochs=3, gamma=0.997, ent_coef=0.01, tensorboard_log=sess_path, device = "cuda")
